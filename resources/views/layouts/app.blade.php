...
<head>
    ...
    <meta name="keywords"
        content="bike, pick_and_go, bike-project">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/app-assets/css/trix.css') }}">
        <script src="http://maps.google.com/maps/api/js?key=AIzaSyD8HZ9Is3SwaYwv9WiTvWZIKwVH15M8Dbw" type="text/javascript"></script>
...
<body id="body-tag" class="vertical-layout vertical-compact-menu 2-columns fixed-navbar" data-open="click"
