            ...
            <div class="content-body">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="ride"><small class="text-dark">Ride</small></label>
                                                    <select class="form-control" name="ride" id="ride">
                                                        <option value="" selected> - All -</option>
                                                        @foreach ($rides as $ride)
                                                            <option value="{{ $ride->id }}">{{ $ride->reference }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Sales Report (Ride Wise)</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
